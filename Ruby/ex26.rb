...
module Ex26
  ...
  def Ex26.print_first_word(words)
    #this line was edited to ".shift". meaning within the array, the output would be the first word (in this case the sentence 'All').
    word = words.shift
    puts word
  end
...
#this line explains how 'pop' is used within the array,
#in this case the array of sentence. -1 explains the start
#of the array which will count the first word (https://apidock.com/ruby/Array/pop)
    word = words.pop(1)
    puts word
  end
...
#i had to change this to "Ex26.secret_formula"
#(http://stackoverflow.com/questions/31340396/ruby-nomethoderror-even-when-method-is-declared)
...
words = Ex26.break_word(sentence)
sorted_words = Ex26.sorted_words(words)
Ex26.print_first_word(words)
Ex26.print_last_word(words)
